...
echo "=== Recent SAIG logs ==="
sudo journalctl -u saigbox.service --since "5 minutes ago" | grep -E "SAIG|delete_email|pending_delete|Context" | tail -30
ENDSSH
